...
public class ColeccionesCategoriesAdapter extends RecyclerView.Adapter<ColeccionesCategoriesAdapter.ViewHolder> {
    ...
    public ColeccionesCategoriesAdapter(List<Categoria> list, String imgPath, int pressedColor, Context context, RecyclerViewClickListener itemListener) {
        mList = list;
        mImgPath = imgPath;
    ...
    @Override
    public ColeccionesCategoriesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final ColeccionesCategoriesAdapter.ViewHolder holder, final int position) {
