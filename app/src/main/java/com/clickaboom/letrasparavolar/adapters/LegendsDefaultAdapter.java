...
public class LegendsDefaultAdapter extends RecyclerView.Adapter<LegendsDefaultAdapter.ViewHolder> {
    ...
    public LegendsDefaultAdapter(List<Collections> bookList, Context context) {
        mContext = context;
        mBookList = bookList;
    }
    ...
    @Override
    public LegendsDefaultAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
